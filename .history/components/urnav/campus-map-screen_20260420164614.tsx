...
import { CAMPUS_BUILDINGS, CampusRoom } from '@/lib/campus-data';
...
export function CampusMapScreen() {
  ...
  const selectedBuilding = selectedBuildingId ? CAMPUS_BUILDINGS.find(b => b.id === selectedBuildingId) : null;
  const selectedRoom = selectedRoomId
    ? CAMPUS_BUILDINGS.flatMap(b => b.rooms).find(r => r.id === selectedRoomId)
    : null;
