  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        // At high zoom (zoomed in): buildings appear farther apart, can reduce spacing
        const zoomFactor = Math.sqrt(view.scale);
        const minDistance = Math.max(8, 25 / zoomFactor); // Minimum distance between building centers in screen pixels
        const maxOffset = Math.max(4, 15 / zoomFactor); // Maximum offset to apply
