...
export function CampusMapCanvas({
  ...
  useEffect(() => {
    setView((prev) => ({ ...prev, screenW: width, screenH: height }));
  }, [width, height]);
...
// Changes:
// - Implemented all 17 visual layers from the enhancement spec
// - Added garden zones, trees, sports ground, roads, and buildings
// - Gate markers, KCEV area overlay, parking areas
// - Route rendering with marching ants animation
// - User position dot with pulse animation and trail
// - WiFi and Kalman position dots for demo mode
// - Destination pin with pulse effect
